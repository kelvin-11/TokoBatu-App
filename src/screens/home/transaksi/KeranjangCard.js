...
export default function KeranjangCard({ item, setisLoading }) {
    ...
    const Quantity = async (id, qty) => {
        try {
            ...
            const res = await fetch('http://192.168.1.27:8080/TokoBatu/web/api/pesanan/updated', {
                method: 'POST',
                body: formData,
                headers: {
    ...
    const Hapus = async (data) => {
        ...
        try {
            ...
            const res = await fetch(
                'http://192.168.1.27:8080/TokoBatu/web/api/pesanan/remove-keranjang', {
                method: 'POST',
                body: formData,
                headers: {
                    'Auth': 'Bearer ' + secret_token,
                        ...
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <TouchableOpacity style={{ paddingRight: 20 }}>
                                    <Image source={{
                                        uri: 'http://192.168.1.27:8080/' + data.img
                                    }}
