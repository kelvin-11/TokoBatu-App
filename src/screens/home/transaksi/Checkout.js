...
const Checkout = ({ navigation }) => {
    ...
    useEffect(() => {
        //Api Provinsi
        axios('http://192.168.1.27:8080/TokoBatu/web/api/jasa-kirim/provinsi', {
            method: 'GET',
        })
            .then(response => {
    ...
    const handleState = (provinsi) => {
        axios(`http://192.168.1.27:8080/TokoBatu/web/api/jasa-kirim/district?id_provinsi=${provinsi}`, {
            method: 'GET',
        })
            .then(response => {
                const count = Object.keys(response.data.data).length;
    ...
    useEffect(() => {
        //API Jasa Kirim
        axios('http://192.168.1.27:8080/TokoBatu/web/api/jasa-kirim/jasa', {
            method: 'GET',
        })
            .then(res => {
    ...
    const handlePaket = (district, courier) => {
        axios(`http://192.168.1.27:8080/TokoBatu/web/api/jasa-kirim/paket?destination=${district}&weight=1000&courier=${courier}`, {
            method: 'GET',
        })
            .then(response => {
                const count = Object.keys(response.data.data).length;
    ...
    const Checkout = async () => {
        try {
            ...
            const res = await fetch(
                'http://192.168.1.27:8080/TokoBatu/web/api/pesanan/update-pesanan', {
                method: 'POST',
                body: formData,
                headers: {
    ...
    const CheckoutFiks = async () => {
        try {
            ...
            const res = await fetch(
                'http://192.168.1.27:8080/TokoBatu/web/api/pesanan/checkout', {
                method: 'POST',
                body: formData,
                headers: {
                    'Auth': 'Bearer ' + secret_token,
